...
class Module extends \yii\base\Module
{
     ...
     * @var string
     */
    public $controllerNamespace = 'c006\console\controllers';
    ...
    public function createController($route)
    {
        ...
        $this->defaultRoute = (!$this->defaultRoute || $this->defaultRoute == 'default') ? 'migrate' : $this->defaultRoute;
